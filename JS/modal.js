...
const teamInfo = {
    ...
    "Дергун Андрій": {
        ...
        info: "Навчаюсь в 10-А групі,  мене звати Андрій, цікавлюсь програмуванням, електронною музикою ставлюсь до людей які живуть моментами та полюбляю грати в баскетбол.",
    }
};
