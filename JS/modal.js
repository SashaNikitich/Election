...
const teamInfo = {
    ...
    "Дідківський Андрій": {
        ...
        info: "Тут має бути якась інформація про мене, але воно вам не потрібно і я сам не знаю про, що написати, загалом нічого цікавого, ну максимум хожу в зальчик і тіпа стрітфотографер. Дипломований учень школи молодого політика."
    },
    "Дєдух Ілля": {
    ...
    "Парфенюк Вікторія": {
        ...
        info: "Привітики! Мене звати Віка. Займаюсь бадмінтоном, якщо не подружимось, можу зарядити воланчиком в око. Дуже дружелюбна і добра! Буду рада зробити свій вклад в життя ліцею)",
    },
    "Дергун Андрій": {
        role: "Інноваційний сектор",
        info: "Навчаюсь в 10-А групі,  мене звати Андрій, цікавлюсь програмуванням, електронною музикою, належу до людей які живуть моментами та полюбляю грати в баскетбол.",
    }
};
